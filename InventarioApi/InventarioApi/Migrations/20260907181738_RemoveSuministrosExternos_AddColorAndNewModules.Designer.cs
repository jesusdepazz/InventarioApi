...
namespace InventarioApi.InventarioApi.Migrations
{
    ...
    [Migration("20260907181738_RemoveSuministrosExternos_AddColorAndNewModules")]
    partial class RemoveSuministrosExternos_AddColorAndNewModules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryApi.Models.Alerta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryApi.Models.BitacoraFalla", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryApi.Models.CatalogoEquipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryApi.Models.FaltanteSobrante", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FaltantesSobrantes");
                });

            modelBuilder.Entity("InventoryApi.Models.PolizaSeguro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryApi.Models.ReporteEstadoFisico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReportesEstadoFisico");
                });

            modelBuilder.Entity("InventoryApi.Models.TomaFisica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TomasFisicas");
                });

            modelBuilder.Entity("InventoryApi.Models.TomaFisicaItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TomaFisicaId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TomaFisicaId");

                    b.ToTable("TomaFisicaItems");
                });
            ...
            modelBuilder.Entity("InventoryApi.Models.TomaFisicaItem", b =>
                {
                    b.HasOne("InventoryApi.Models.TomaFisica", null)
                        .WithMany("Items")
                        .HasForeignKey("TomaFisicaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
